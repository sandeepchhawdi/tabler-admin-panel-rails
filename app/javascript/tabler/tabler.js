...
document.addEventListener("turbo:load", function () {
	(function (factory) {
		...
		const turbo: loadCallbacks = [];
		const onturbo: load = callback => {
			if (document.readyState === 'loading') {
				if (!turbo: loadCallbacks.length) {
		document.addEventListener('turbo:load', () => {
			turbo: loadCallbacks.forEach(callback => callback());
		});
	}
				turbo: loadCallbacks.push(callback);
} else {
	callback();
}
		};
...
const nativeEvents = new Set(['click', 'dblclick', 'mouseup', 'mousedown', 'contextmenu', 'mousewheel', 'DOMMouseScroll', 'mouseover', 'mouseout', 'mousemove', 'selectstart', 'selectend', 'keydown', 'keypress', 'keyup', 'orientationchange', 'touchstart', 'touchmove', 'touchend', 'touchcancel', 'pointerdown', 'pointermove', 'pointerup', 'pointerleave', 'pointercancel', 'gesturestart', 'gesturechange', 'gestureend', 'focus', 'blur', 'change', 'reset', 'select', 'submit', 'focusin', 'focusout', 'load', 'unload', 'beforeunload', 'resize', 'move', 'turbo:load', 'readystatechange', 'error', 'abort', 'scroll']);
